...
| OS      | Code                                                                                                           |
|---------+----------------------------------------------------------------------------------------------------------------|
| macOS   | src_sh[:exports code]{bash -c "$(curl -LsS https://raw.github.com/jdominpa/dotfiles/master/src/os/setup.sh)"}  |
| Linux   | src_sh[:exports code]{bash -c "$(wget -qO - https://raw.github.com/jdominpa/dotfiles/master/src/os/setup.sh)"} |
|---------+----------------------------------------------------------------------------------------------------------------|
