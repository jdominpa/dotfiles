...
** Configurations for in-built search commands
:PROPERTIES:
:CUSTOM_ID: in-built_search
:END:
...
Moving on to my own configuration, here is my setup for these in-built
tools:
...
Configuration for everything that but normally be a standalone
