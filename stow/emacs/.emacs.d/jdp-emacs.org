...
#+begin_src emacs-lisp
  (use-package jdp-fonts
    ...
    (setq jdp-fonts-typeface-sets-alist
          '((desktop 130 "Iosevka" normal "Inter" normal)
...
*** Minibuffer configurations and extras (mct)
:PROPERTIES:
...
focus on the latter.  At the moment I'm trying the =mct= package
developed by Protesilaos Stavrou although I might try the package
=vertico= in the future.
...
#+begin_src emacs-lisp
  ...
  (use-package mct
    ...
    (setq mct-completion-passlist nil
