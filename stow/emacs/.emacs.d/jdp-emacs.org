...
switch the position of some elements of the modeline.
...
** TODO Line/column numbers and relevant indicators
:PROPERTIES:
:CUSTOM_ID: numbers_relevant_indicators
:END:

In this section I setup some indicators like the =diff-hl= package and
I ensure that the modeline shows the line and column numbers.
